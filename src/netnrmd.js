    ...
    netnrmd.fn = netnrmd.prototype = {
        init: function (id, obj) {
            ...
            $(obj.items).each(function () {
                var keytip = this.title + "/" + this.cmd + " " + (this.key ? obj.prefixkey + this.key : '');
                lis.push('<li class="' + (this.class || "") + '" data-cmd="' + this.cmd + '" title="' + keytip + '">');
