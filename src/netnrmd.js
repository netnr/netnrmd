...
(function (window) {
    ...
    //表情，https://emoji.netnr.com
    netnrmd.emoji = {
        path: "https://emoji.netnr.com/emoji/wangwang/",
            ...
            case "emoji":
                {
                    ...
                    if (!that.emojipopup) {
                        var htm = [];
                        $.each(netnrmd.emoji.list, function (i, v) {
                            htm.push('<img class="netnrmd-emoji" title="' + v + '" src="' + netnrmd.emoji.path + i + netnrmd.emoji.ext + '" />');
                        });
